  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-10 select-none">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 px-8">
        <motion.p
          style={{ opacity: s4a }}
          className="text-center text-2xl font-extralight tracking-[0.02em] text-porcelain sm:text-3xl md:text-5xl"
        >
          Reality is expensive.
        </motion.p>
        <motion.p
          style={{ opacity: s4b }}
          className="text-center text-2xl font-extralight tracking-[0.02em] text-titanium sm:text-3xl md:text-5xl"
        >
          Simulation isn't.
        </motion.p>
      </div>
